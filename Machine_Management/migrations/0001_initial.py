# Generated by Django 3.0.8 on 2020-09-16 15:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machine_brand', models.CharField(blank=True, max_length=10)),
                ('machine_model', models.CharField(blank=True, max_length=10)),
                ('machine_supplier_code', models.CharField(blank=True, max_length=10)),
                ('machine_emp_id_response', models.CharField(blank=True, max_length=15)),
                ('machine_capacity_per_minute', models.CharField(blank=True, max_length=10)),
                ('machine_capacity_measure_unit', models.CharField(blank=True, max_length=10)),
                ('machine_power_use_watt_per_hour', models.CharField(blank=True, max_length=10)),
                ...
                ('machine_image1', models.CharField(blank=True, max_length=50)),
                ('machine_image2', models.CharField(blank=True, max_length=50)),
                ('machine_image3', models.CharField(blank=True, max_length=50)),
                ('machine_image4', models.CharField(blank=True, max_length=50)),
                ('machine_image5', models.CharField(blank=True, max_length=50)),
                ('machine_document1', models.CharField(blank=True, max_length=50)),
                ('machine_document2', models.CharField(blank=True, max_length=50)),
                ('machine_document3', models.CharField(blank=True, max_length=50)),
                ('machine_document4', models.CharField(blank=True, max_length=50)),
                ('machine_document5', models.CharField(blank=True, max_length=50)),
